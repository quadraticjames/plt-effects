...
(control (λ x x) (ρ) ((arg unit (ρ))))
   |#
   (--> (control (if e_1 e_2 e_3 e_4) r (f ...) k ...)
        (control e_1 r ((if1 e_2 e_3 e_4 r) f ...) k ...)
        "if1")
   (--> (return ((ret v) (if1 e_2 e_3 e_4 r) f ...) k ...)
        (control e_2 r ((if2 v e_3 e_4 r) f ...) k ...)
        "if2")
   (--> (return ((ret string_1) (if2 string_1 e_3 e_4 r) f ...) k ...)
        (control e_3 r (f ...) k ...)
        "iftrue")
   (--> (return ((ret string_2) (if2 string_1 e_3 e_4 r) f ...) k ...)
        (control e_4 r (f ...) k ...)
